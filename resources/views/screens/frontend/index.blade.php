                    ...
                    <div class="row-auto text-center">
                        {!! Form::open() !!}
                            <div class="flex relative justify-center">
                                ...
                                <button type="submit" class="bg-[#9D5933] bg-gradient-to-r hover:bg-[#F4935E] duration-300 text-white px-8 rounded-r-3xl py-1">SUBSCRIBE</button>
                            </div>
                        {!! Form::close() !!}
                    </div>
                </div>
